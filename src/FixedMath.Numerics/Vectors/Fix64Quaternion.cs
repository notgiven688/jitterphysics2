...
namespace FixedMath.Numerics
{
    ...
    /// </summary>
    public struct Fix64Quaternion : IEquatable<Quaternion>
    {
        private static readonly Single SlerpEpsilon = 1e-6f;
        ...
        public Fix64Quaternion(Single x, Single y, Single z, Single w)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        /// <param name="value2">The scalar value.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Quaternion operator *(Quaternion value1, Single value2)
        {
            Quaternion ans;
