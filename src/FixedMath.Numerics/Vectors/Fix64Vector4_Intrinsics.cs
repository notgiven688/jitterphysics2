...
namespace FixedMath.Numerics
{
    ...
    public partial struct Fix64Vector4
    {
        /// <summary>
        ...
        [Intrinsic]
        public Fix64Vector4(Single value)
        ...
        [Intrinsic]
        public Fix64Vector4(Single x, Single y, Single z, Single w)
        {
            W = w;
            X = x;
            Y = y;
        ...
        [Intrinsic]
        public Fix64Vector4(Vector2 value, Single z, Single w)
        {
            X = value.X;
            Y = value.Y;
            Z = z;
