...
namespace FixedMath.Numerics
{
    ...
    /// </summary>
    public struct Fix64Matrix3x2 : IEquatable<Matrix3x2>
    {
        private static readonly Single RotationEpsilon = 0.001f * MathF.PI / 180f;     // 0.1% of a degree
        ...
        /// </summary>
        public Fix64Matrix3x2(Single m11, Single m12,
                         Single m21, Single m22,
                         Single m31, Single m32)
        {
            this.M11 = m11;
            this.M12 = m12;
            this.M21 = m21;
        ...
        /// <param name="value2">The scaling value to use.</param>
        /// <returns>The resulting matrix.</returns>
        public static Matrix3x2 operator *(Matrix3x2 value1, Single value2)
        {
            Matrix3x2 m;
