...
namespace FixedMath.Numerics
{
    ...
    public struct Fix64Matrix4x4 : IEquatable<Matrix4x4>
    {
        private static readonly Single BillboardEpsilon = 1e-4f;
        private static readonly Single BillboardMinAngle = 1.0f - (0.1f * (MathF.PI / 180.0f)); // 0.1 degrees
        private static readonly Single DecomposeEpsilon = 0.0001f;
        ...
        /// </summary>
        public Fix64Matrix4x4(Single m11, Single m12, Single m13, Single m14,
        ...
        public Fix64Matrix4x4(Matrix3x2 value)
        {
            M11 = value.M11;
            M12 = value.M12;
            M13 = 0f;
        ...
        public static Matrix4x4 CreateBillboard(Vector3 objectPosition, Vector3 cameraPosition, Vector3 cameraUpVector, Vector3 cameraForwardVector)
        {
            ...
            Single norm = zaxis.LengthSquared();
        ...
        public static Matrix4x4 CreateConstrainedBillboard(Vector3 objectPosition, Vector3 cameraPosition, Vector3 rotateAxis, Vector3 cameraForwardVector, Vector3 objectForwardVector)
        {
            ...
            Single norm = faceDir.LengthSquared();
            ...
            Single dot = Vector3.Dot(rotateAxis, faceDir);
        ...
        public static Matrix4x4 CreateScale(Single xScale, Single yScale, Single zScale, Vector3 centerPoint)
        {
            ...
            Single tx = centerPoint.X * (1 - xScale);
            Single ty = centerPoint.Y * (1 - yScale);
            Single tz = centerPoint.Z * (1 - zScale);
        ...
        public static Matrix4x4 CreateScale(Vector3 scales, Vector3 centerPoint)
        {
            ...
            Single tx = centerPoint.X * (1 - scales.X);
            Single ty = centerPoint.Y * (1 - scales.Y);
            Single tz = centerPoint.Z * (1 - scales.Z);
        ...
        public static Matrix4x4 CreateScale(Single scale, Vector3 centerPoint)
        {
            ...
            Single tz = centerPoint.Z * (1 - scale);
        ...
        public static Matrix4x4 CreateRotationX(Single radians)
        {
            ...
            Single c = MathF.Cos(radians);
            Single s = MathF.Sin(radians);
        ...
        public static Matrix4x4 CreateRotationX(Single radians, Vector3 centerPoint)
        {
            ...
            Single y = centerPoint.Y * (1 - c) + centerPoint.Z * s;
            Single z = centerPoint.Z * (1 - c) - centerPoint.Y * s;
        ...
        public static Matrix4x4 CreateRotationY(Single radians, Vector3 centerPoint)
        {
            ...
            Single x = centerPoint.X * (1 - c) - centerPoint.Z * s;
            Single z = centerPoint.Z * (1 - c) + centerPoint.X * s;
        ...
        public static Matrix4x4 CreateFromAxisAngle(Vector3 axis, Single angle)
        {
            ...
            Single sa = MathF.Sin(angle), ca = MathF.Cos(angle);
        ...
        public static Matrix4x4 CreatePerspectiveFieldOfView(Single fieldOfView, Single aspectRatio, Single nearPlaneDistance, Single farPlaneDistance)
        {
            ...
            Single yScale = 1.0f / MathF.Tan(fieldOfView * 0.5f);
            ...
            var negFarRange = Single.IsPositiveInfinity(farPlaneDistance) ? -1.0f : farPlaneDistance / (nearPlaneDistance - farPlaneDistance);
        ...
        public static Matrix4x4 CreateFromQuaternion(Quaternion quaternion)
        {
            ...
            Single wz = quaternion.Z * quaternion.W;
            Single xz = quaternion.Z * quaternion.X;
            Single wy = quaternion.Y * quaternion.W;
            Single yz = quaternion.Y * quaternion.Z;
            Single wx = quaternion.X * quaternion.W;
        ...
        public static Matrix4x4 CreateShadow(Vector3 lightDirection, Plane plane)
        {
            ...
            Single dot = p.Normal.X * lightDirection.X + p.Normal.Y * lightDirection.Y + p.Normal.Z * lightDirection.Z;
            Single a = -p.Normal.X;
            Single b = -p.Normal.Y;
            Single c = -p.Normal.Z;
            Single d = -p.D;
        ...
        public static Matrix4x4 CreateReflection(Plane value)
        {
            ...
            Single a = value.Normal.X;
            Single b = value.Normal.Y;
            Single c = value.Normal.Z;
        ...
        public Single GetDeterminant()
        {
            ...
            Single a = M11, b = M12, c = M13, d = M14;
            Single e = M21, f = M22, g = M23, h = M24;
            Single i = M31, j = M32, k = M33, l = M34;
            Single m = M41, n = M42, o = M43, p = M44;

            Single kp_lo = k * p - l * o;
            Single jp_ln = j * p - l * n;
            Single jo_kn = j * o - k * n;
            Single ip_lm = i * p - l * m;
            Single io_km = i * o - k * m;
            Single in_jm = i * n - j * m;
        ...
        public static bool Invert(Matrix4x4 matrix, out Matrix4x4 result)
        {
            ...
            Single a = matrix.M11, b = matrix.M12, c = matrix.M13, d = matrix.M14;
            Single e = matrix.M21, f = matrix.M22, g = matrix.M23, h = matrix.M24;
            Single i = matrix.M31, j = matrix.M32, k = matrix.M33, l = matrix.M34;
            Single m = matrix.M41, n = matrix.M42, o = matrix.M43, p = matrix.M44;
            ...
            Single a11 = +(f * kp_lo - g * jp_ln + h * jo_kn);
            Single a12 = -(e * kp_lo - g * ip_lm + h * io_km);
            Single a13 = +(e * jp_ln - f * ip_lm + h * in_jm);
            Single a14 = -(e * jo_kn - f * io_km + g * in_jm);

            Single det = a * a11 + b * a12 + c * a13 + d * a14;

            if (MathF.Abs(det) < Single.Epsilon)
            {
                result = new Matrix4x4(Single.NaN, Single.NaN, Single.NaN, Single.NaN,
                                       Single.NaN, Single.NaN, Single.NaN, Single.NaN,
                                       Single.NaN, Single.NaN, Single.NaN, Single.NaN,
                                       Single.NaN, Single.NaN, Single.NaN, Single.NaN);
                return false;
            }
            ...
            Single gp_ho = g * p - h * o;
            Single fp_hn = f * p - h * n;
            Single fo_gn = f * o - g * n;
            Single ep_hm = e * p - h * m;
            Single eo_gm = e * o - g * m;
            Single en_fm = e * n - f * m;
            ...
            Single gl_hk = g * l - h * k;
            Single fl_hj = f * l - h * j;
            Single fk_gj = f * k - g * j;
            Single el_hi = e * l - h * i;
            Single ek_gi = e * k - g * i;
            Single ej_fi = e * j - f * i;
        ...
        //        {
        //            Single* pfScales = (Single*)scaleBase;
        //            Single det;
        ...
        //            uint a, b, c;
        //            #region Ranking
        //            Single x = pfScales[0], y = pfScales[1], z = pfScales[2];
        //            if (x < y)
        //            {
        //                if (y < z)
        //                {
        ...
        public static Matrix4x4 Transform(Matrix4x4 value, Quaternion rotation)
        {
            ...
            Single q11 = 1.0f - yy2 - zz2;
            Single q21 = xy2 - wz2;
            Single q31 = xz2 + wy2;

            Single q12 = xy2 + wz2;
            Single q22 = 1.0f - xx2 - zz2;
            Single q32 = yz2 - wx2;

            Single q13 = xz2 - wy2;
            Single q23 = yz2 + wx2;
            Single q33 = 1.0f - xx2 - yy2;
        ...
        public static /*unsafe*/ Matrix4x4 Transpose(Matrix4x4 matrix) // TODO
        {
#if HAS_INTRINSICS
            if (Sse.IsSupported)
            {
        ...
        public static /*unsafe*/ Matrix4x4 Lerp(Matrix4x4 matrix1, Matrix4x4 matrix2, Single amount) // TODO
        {
#if HAS_INTRINSICS
            if (Sse.IsSupported)
            {
                Vector128<Single> amountVec = Vector128.Create(amount);
        ...
        public static Matrix4x4 Multiply(Matrix4x4 value1, Single value2) => value1 * value2;
        ...
        /// <param name="value">The source matrix.</param>
        /// <returns>The negated matrix.</returns>
        public static /*unsafe*/ Matrix4x4 operator -(Matrix4x4 value) // TODO
        {
#if HAS_INTRINSICS
            if (Sse.IsSupported)
            {
                Vector128<Single> zero = Vector128<Single>.Zero;
        ...
        /// <param name="value2">The second source matrix.</param>
        /// <returns>The resulting matrix.</returns>
        public static /*unsafe*/ Matrix4x4 operator +(Matrix4x4 value1, Matrix4x4 value2) // TODO
        {
#if HAS_INTRINSICS
            if (Sse.IsSupported)
            {
        ...
        /// <param name="value2">The scaling factor.</param>
        /// <returns>The scaled matrix.</returns>
        public static /*unsafe*/ Matrix4x4 operator *(Matrix4x4 value1, Single value2) // TODO
        {
#if HAS_INTRINSICS
            if (Sse.IsSupported)
            {
                Vector128<Single> value2Vec = Vector128.Create(value2);
        ...
        public static /*unsafe*/ bool operator ==(Matrix4x4 value1, Matrix4x4 value2) // TODO
        {
#if HAS_INTRINSICS
            if (Sse.IsSupported)
            {
