...
namespace FixedMath.Numerics
{
    internal partial class SR
    {
        ...
        // TODO
        public static string Arg_NullArgumentNullRef => nameof(Arg_NullArgumentNullRef);
        public static string Arg_ArgumentOutOfRangeException => nameof(Arg_ArgumentOutOfRangeException);
        public static string Arg_ElementsInSourceIsGreaterThanDestination => nameof(Arg_ElementsInSourceIsGreaterThanDestination);
    }
}
