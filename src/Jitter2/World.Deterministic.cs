    ...
    private void SortForIslands()
    {
        ...
        for (int i = 0; i < small.Length; i++)
        {
            ...
            sortedSmallConstraints.Add(new SmallConstraintEntry
            {
                ...
                HandleId = handle.Data._internal
            });
        }
        ...
        // Group constraints by island and use the stable handle ID as a deterministic
        // tie-breaker within each island.
