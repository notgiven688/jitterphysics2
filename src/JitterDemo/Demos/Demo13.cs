...
public class Demo13 : IDemo
{
    ...
    public void Build()
    {
...

        {
            ...
            b0.AddShape(new BoxShape(2, 0.1, 0.1));
            b0.Position = new JVector(-1.1, 4, 0);

            var b1 = world.CreateRigidBody();
            b1.AddShape(new BoxShape(2, 0.1, 0.1));
            b1.Position = new JVector(1.1, 4, 0);
...

        {
            ...
            var b0 = world.CreateRigidBody();
            b0.AddShape(new BoxShape(2, 0.1, 3));
            b0.AddShape(new BoxShape(0.1, 2, 2.9));
            ...
            hj.HingeAngle.Bias = 0.3;
            hj.HingeAngle.Softness = 0.0;
            hj.HingeAngle.LimitBias = 0.3;
            hj.HingeAngle.LimitSoftness = 0.0;
