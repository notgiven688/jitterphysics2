...
public class Demo19 : IDemo
{
    public void Draw()
    {
        ...
        {
            JVector dir = JVector.Transform(rayVector, JMatrix.CreateRotationX(0.1 + 0.0001 * i));
            dir = 60.0 * JVector.Transform(dir, JMatrix.CreateRotationY(0.004 * i));
            ...
            bool hit = world.DynamicTree.RayCast(origin, dir, null, null, out IDynamicTreeProxy? shape,
                out JVector normal, out double frac);
    ...
    public void Build()
    {
        ...
        box.Position = new JVector(0, 0.5, -6);
        box.IsStatic = true;
    }
}