...
public class RayCastCar
{
    ...
    public RayCastCar(World world)
    {
        ...
        TransformedShape tfs1 = new(new BoxShape(3.1d, 1.4d, 8f), new JVector(0, 0.4d, 0));
        TransformedShape tfs2 = new(new BoxShape(2.4d, 0.8d, 5f), new JVector(0.0d, 1.5d, 1.1d));
