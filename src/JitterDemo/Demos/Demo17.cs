...
public class Demo17 : IDemo, ICleanDemo
{
    ...
    public void Build()
    {
        ...
        b0.Orientation = JQuaternion.CreateRotationX(0.4);

        var b1 = world.CreateRigidBody();
        b1.Position = new JVector(0, 10, 0);
        b1.AddShape(new CapsuleShape(0.4));
        b1.Orientation = JQuaternion.CreateRotationX(1);

        var b2 = world.CreateRigidBody();
        b2.Position = new JVector(1, 11, 0);
        b2.AddShape(new SphereShape(0.5));
